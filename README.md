...
Update: A local-first version can be found [here](https://github.com/xup60521/contextboard/tree/migration/local-first).
Visit https://contextboard-local.xup60521.workers.dev to play around with it.
