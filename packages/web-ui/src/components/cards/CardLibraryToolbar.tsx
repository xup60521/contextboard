...
const CARD_SORT_OPTIONS: CardSortOrder[] = [
	"title",
	"title_desc",
	"updated_desc",
	"updated_asc",
];
const labels: Record<CardSortOrder, string> = {
	title: "Title A-Z",
	title_desc: "Title Z-A",
	updated_desc: "Recently updated",
	updated_asc: "Least recently updated",
};
const getCardSortLabel = (value: CardSortOrder) => labels[value];
const isCardSortBy = (value: string): value is CardSortOrder =>
	CARD_SORT_OPTIONS.includes(value as CardSortOrder);
...
export function CardLibraryToolbar({
	...
	onSortChange: (sort: CardSortOrder) => void;
