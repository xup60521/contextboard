...
export function groupPlacementsByWhiteboard(
	placements: Placement[],
	whiteboardTitleById: Map<string, string>,
): PlacementGroup[] {
							...
							<div className="grid gap-0.5">
								{backlinks.map((bl) => (
									<button
										...
										onClick={() => {
											onNavigate?.();
											navigation.navigate(navigation.cardHref(bl.cardId));
										}}
						...
						{placementGroups.map((group) => {
							...
							<button
								...
								onClick={() => {
									...
									navigation.navigate(
										group.whiteboardId
											? navigation.whiteboardHref(group.whiteboardId, {
													focus: p.shapeId ?? undefined,
												})
											: navigation.rootWhiteboardHref(),
									);
								}}
